...
const ProductDisplay = ({ id }: Props) => {
  ...
  return loading ? (
    ...
    <>
        ...
        <div className="flex flex-col gap-4">
          <div className="rounded overflow-hidden shadow-lg bg-white h-fit">
            <div className="px-6 py-4">
              ...
              <p className="text-gray-700 text-[16px]">{product?.title}</p>
      ...
      <p className="m-24 text-[12px]">
        {" "}
        <b> Disclaimer</b>: Please note that OLX serves as online marketplace
        and intermediary and merely providing the platform to the listers to
        list their businesses. The products listed on our platform are provided
        by third party i.e listers with the pricing marked at their discretion.
